...
\begin{document}
\begin{landscape}
\begin{longtable}{p{1.25cm}>{\raggedright}p{2.5cm}>{\raggedright}p{6.5cm}>{\raggedright}p{3.5cm}>{\raggedright}p{3.5cm}>{\raggedright}p{7cm}}
\toprule
...
\tenevilglyph[yes][4]{i_2cU_2cD}
	...
	&	[38.1] \linebreak
		qlaula [ӄԓявыԓя = мужчина; напечатано в книге, знак рядом] [12.17об] % TODO: уточнить перевод
		\tabularnewline \midrule
...
\tenevilglyph[yes][4]{o_l_j2Y}
	...
	& 	ьrgen [ыргин = их, принадлежащий им] [ИЛИ:1.3, ИЛИ:2.1]
		\tabularnewline \midrule
\tenevilglyph[yes][1]{o_l_j2Y_2c}
	&
	&	
	&	
	&	
	& 	эmьrgen [ИЛИ:1.17] % TODO: нужен перевод
		\tabularnewline \midrule
...
\tenevilglyph[yes][4]{o_q_'}
	...
	& 	\cite[360, 364]{davydova2015a} \linebreak
		...
		\tabularnewline \midrule
\tenevilglyph[yes][1]{o_q_2c}
	&
	&	
	& 	
	&	
	& 	эmьnkь [ИЛИ:1.7] % TODO: нужен перевод
		\tabularnewline \midrule
