...
\tenevilglyph[yes][4]{i_cUY_2cD}
	...
	&	irьn [иръын = кухлянка, мужская меховая рубаха, пальто, верхняя одежда; напечатано в книге, знак рядом] [7.13, 12.23] \linebreak
		rarrok [= за пазуху; напечатано в книге, знак рядом] \currentGlyphWithAffixes{}{R,K} [12.19об] % Обрати внимание, фонетический ключ используется для совсем другого слова
		\tabularnewline \midrule
...
\tenevilglyph[yes][4]{o_2j}
	...
	& 	\cite[364]{davydova2015a} \linebreak
		...
		murьk [мурык = у нас; напечатано в книге, знак рядом] \currentGlyphWithAffixes{K}{} [12.22]
		\tabularnewline \midrule
