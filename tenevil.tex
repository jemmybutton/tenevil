...
\toprule
 ...
 \tenevilglyph{i_2cU_2cD}
	&	qlaul [= мужчина] \cite[л. 64 об.]{spbfaran79} % ӄԓявыԓ
	& 
	& 
	& 	мужчина 
	&   \\ \midrule
\tenevilglyph{i_2cU_2cD_'}
	&	отец \cite[л. 40, 55]{spbfaran79}\linebreak
		әtlьgьn [= отец] \cite[л. 52]{spbfaran79}\linebreak % ытлыгын
		әtlьgә \cite[л. 52]{spbfaran79}\linebreak
		etlьgьn [әtlьgьn] \cite[л. 52 об.]{spbfaran79}\linebreak
		ьnpenacgen [= старик] \cite[л. 64]{spbfaran79} % ынпыначгын
	& 	отец
	& 
	& 
	&  + \\ \midrule
\tenevilglyph{i_2cU_j_2cD}
	&	uwaqug [uwæquc = муж] \cite[л. 65 об.]{spbfaran79} % ы'вэӄуч
	& 
	&
	& 
	&  + \\ \midrule
\tenevilglyph{i_2cU_2C}
	&	ŋәucqan [ŋausqan = женщина] \cite[л. 65 об.]{spbfaran79} % ӈэвысӄэт
	& 
	&	a woman
	& 
	&  + \\ \midrule
...
\tenevilglyph{i_2cU_l_2C}
	&	мать \cite[л. 64]{spbfaran79}\linebreak
		әtla [= мать] \cite[л. 52]{spbfaran79}\linebreak % ытԓя
...
\tenevilglyph{i_2cU_2C_h}
	&	ьnpьŋәu [ьnpь-ŋæw = старуха] \cite[л. 65 об]{spbfaran79} % ынпыӈэв
	& 
	&	
	& 
	&  \\ \midrule
\tenevilglyph{i_2CF}
	&	сын \cite[л. 52]{spbfaran79}\linebreak
		...
		әkkot [ækkæt = сыновья] \cite[л. 39]{spbfaran79} \linebreak % экык
...
\tenevilglyph{i_vd_q_i} 
	...
	& 	+ \\ \midrule
\tenevilglyph{i_2CF_j}
	&	qlaul nenene [qlaul nænænæ = мужчина младенец] \cite[л. 65 об]{spbfaran79} % ӄԓявыԓ нэнэны
	& 
	&	
	& 
	& 	+ \\ \midrule
\tenevilglyph{i_2cU_CF_h}
	&	ŋәusqan neneneŋ [ŋausqan nænænæŋ = женщина мланедец] \cite[л. 65 об]{spbfaran79} % ӈэвысӄэт нэнэны
	& 
	&	
	& 
	&  \\ \midrule
\tenevilglyph{o-_p_j}
	&	он \cite[л. 40]{spbfaran79} \linebreak 
		әtlon [= он] \cite[л. 39 об, 52, 65 об]{spbfaran79} % ытԓён
	& 	он
	&	
	& 
	&  	+ \\ \midrule
\tenevilglyph{o_2j}
	&	наш \cite[л. 40]{spbfaran79} \linebreak
		murgin [= наш] \cite[л. 52]{spbfaran79} \linebreak % мургин
		muri [= мы] \cite[л. 39 об, 65 об]{spbfaran79} \linebreak % мури
...
\tenevilglyph{o_j}
	&	мой \cite[л. 40, 55]{spbfaran79} \linebreak
		gьmnin [= мой] \cite[л. 56]{spbfaran79} \linebreak % гымнин
...
\tenevilglyph{o}
	&	я \cite[л. 40, 53, 65 об]{spbfaran79} \linebreak
		gьm [= я]\cite[л. 52,56]{spbfaran79} \linebreak % гым
...
\tenevilglyph{o_j_q}
	...
	& 	+ \\ \midrule
\tenevilglyph{o-_s}
	&	gьt [= ты]  \cite[л. 65 об]{spbfaran79} % гыт
	& 	
	&	
	& 
	& 	\\ \midrule
\tenevilglyph{o-_jY}
	&	turi [= вы]  \cite[л. 65 об]{spbfaran79} % тури
	& 	
	&	
	& 
	& 	\\ \midrule
\tenevilglyph{R_2bN}
	&	сеть \cite[л. 40]{spbfaran79} \linebreak
		giŋingi [giŋingь = сеть] \cite[л. 39]{spbfaran79} \linebreak % гиӈынгиӈ
...
\tenevilglyph{iY_j}
	&	сам \cite[л. 40, 53]{spbfaran79} \linebreak
		cinit [cinit = сам] \cite[л. 52]{spbfaran79} \linebreak % чинит
...
\tenevilglyph{iY}
	&	тот \cite[л. 40]{spbfaran79} \linebreak
		әnqon [әnqan = тот] \cite[л. 52, 54]{spbfaran79} % ынӄэн
	& 	тот
	&	
	& 	
	& 	+ \\ \midrule
\tenevilglyph{d_C}
	&	нет \cite[л. 40]{spbfaran79} \linebreak
		ujŋә [= нет чего-нибудь] \cite[л. 39]{spbfaran79} \linebreak % уйӈэ
...
\tenevilglyph{G}
	&	теперь \cite[л. 40]{spbfaran79} \linebreak
		igьt [= сегодня, теперь] \cite[л. 39, 52 об]{spbfaran79} \linebreak % игыр
...
\tenevilglyph{2i_P}
	&	на реке \cite[л. 41]{spbfaran79} \linebreak
		veemьk [vææmьk = на реке] \cite[л. 39]{spbfaran79} % вээмык
	& 	на реке
	&	
	& 	
	& 	+ \\ \midrule
...
\tenevilglyph{2i_2q}
	&	vaamete [vææmьte = к реке] \cite[л. 56]{spbfaran79} \linebreak % вээмэты
...
\tenevilglyph{i_g_b_jX}
	&	хариус \cite[л. 41, 54 об]{spbfaran79} \linebreak
		qe\textbarc aw [kьcaw = хариус] \cite[л. 39]{spbfaran79} % кычав
	& 	хариус
	&	
	& 	
	& 	+ \\ \midrule
...
\tenevilglyph{u_j_jX_j}
	&	еда, есть \cite[л. 41]{spbfaran79} \linebreak
		roьlqal [roolqәl = пища, продукты] \cite[л. 39]{spbfaran79} % рооԓӄыԓ
	& 	еда, есть
	&	food
	& 	
	& 	+ \\ \midrule
...
\tenevilglyph{a}
	&	стадо, олень \cite[л. 42]{spbfaran79} \linebreak
		ŋәlvil [ŋælvьl = стадо (преимущественно оленей)] \cite[л. 56]{spbfaran79} % ӈэԓвыԓ
	& 	стадо, олень
	&	reindeer
	& 	олень
	& 	+ \\ \midrule
...
\tenevilglyph{s_b}
	&	много \cite[л. 42]{spbfaran79} \linebreak
		...
		numkәqin [nьmkәqin = многочисленный]  \cite[л. 54]{spbfaran79} \linebreak % нымкыӄин
...
\tenevilglyph{i_l}
	...
	& 	+ \\ \midrule
\tenevilglyph{v_l}
	&	раньше, \textbarc it [cit = раньше, прежде] \cite[л. 42]{spbfaran79} \linebreak % чит
	...
	& 	+ \\ \midrule
\tenevilglyph{i_LX}
	&	действительно, qәjve [= право, и действительно] \cite[л. 42]{spbfaran79} \linebreak % ӄэйвэ
	...
	& 	+ \\ \midrule
\tenevilglyph{w}
	&	еще не, jep [= еще; пока еще; еще в то время, как] \cite[л. 42]{spbfaran79} \linebreak % еп
...
\tenevilglyph{2c}
	&	кое как, насилу \cite[л. 42]{spbfaran79} \linebreak
		metkiit [mætkiit  = насилу, еле-еле] \cite[л. 39, 52]{spbfaran79} % мэткиит
	& 	
	&	somehow
	& 	
	& 	+ \\ \midrule
\tenevilglyph{I_2l}
	&	совсем, qonpь [= совсем, совершенно] \cite[л. 42]{spbfaran79} \linebreak % ӄонпыӈ
	...
	& 	+ \\ \midrule
\tenevilglyph{wD2E}
	&	притом, qәnver [qanver = также]  \cite[л. 42]{spbfaran79} \linebreak % ӄоныры
...
\tenevilglyph{2o_2iY}
	&	давно \cite[л. 42]{spbfaran79} \linebreak	
		telenjep [tælænjæp = давно] \cite[л. 39 об, 52, 56]{spbfaran79} \linebreak % тэԓенъеп
	...
	& 	+ \\ \midrule
\tenevilglyph{b_q}
	&	также, \textbarc ama [cama = тоже] \cite[л. 42]{spbfaran79} \linebreak	 % чама
...
\tenevilglyph{2i_2cD_2l}
	&	все \cite[л. 42]{spbfaran79} \linebreak	
		ьmьlo [= весь] \cite[л. 52 об]{spbfaran79} % ымыԓьо
	& 	все
	&	all
	& 	
	& 	+ \\ \midrule
\tenevilglyph{U_q}
	&	но \cite[л. 42]{spbfaran79} \linebreak	
		naqam [= но, однако] \cite[л. 39, 52 об, 54, 56]{spbfaran79} % наӄам
	& 	
	&	
	& 	
	& 	+ \\ \midrule
\tenevilglyph{o_2CY}
	&	хорошо \cite[л. 43]{spbfaran79} \linebreak	
		me\textbarc әnkь [mæсәnkь = хорошо] \cite[л. 39, 52]{spbfaran79} \linebreak % мэчынкы
...
\tenevilglyph{2O}
	...
	& 	+ \\ \midrule
\tenevilglyph{o_3iS}
	&	пускай, ma\textbarc ьnan [macьnan = пусть] \cite[л. 43]{spbfaran79} \linebreak %мачынан
...
\tenevilglyph{i_2kU_2kD}
	&	шкура \cite[л. 44]{spbfaran79} \linebreak
		nelgen [nælgьn = шкура]* \cite[л. 49 об]{spbfaran79} \linebreak % нэԓгын
...
\tenevilglyph{o-o_J}
	&	маленький \cite[л. 46]{spbfaran79} \linebreak
		nьpluqin [= маленький] \cite[л. 46]{spbfaran79} % ныппыԓюӄин
	& 	маленький
	&	
	& 	
	& 	+ \\ \midrule
...
\tenevilglyph{2o_2j}
	&	в «стойбище, олени (богатый оленевод)» \cite[л. 47]{spbfaran79} \linebreak
		...
		отлакир [әtlьq- = тундра] \cite[л. 68]{spbfaran79} % эԓԓык-
	& 	
	&	
	& 	
	& 	+ \\ \midrule
...
\tenevilglyph{cF_CF}
	&	так \cite[л. 50]{spbfaran79} \linebreak
		әnmen [= также, итак] \cite[л. 39 об]{spbfaran79} \linebreak % энмэн
...
\tenevilglyph{o_q}
	&	там \cite[л. 50]{spbfaran79} \linebreak
		әnkь [= там] \cite[л. 39 об]{spbfaran79} \linebreak % ынкы
...
\tenevilglyph{o_l}
	&	мало \cite[л. 50]{spbfaran79} \linebreak
		kitkit [= мало, немного] \cite[л. 39 об]{spbfaran79} % киткит
	& 	
	&	
	& 	
	& 	+ \\ \midrule
...
\tenevilglyph{bD_b}
	&	только \cite[л. 50]{spbfaran79} \linebreak
		lien [liæn = как только] \cite[л. 52 об, 56]{spbfaran79} % ԓыгэн
	& 	только
	&	
	& 	
	& 	+ \\ \midrule
...
\tenevilglyph{i_oB}
	&	тайно \cite[л. 50]{spbfaran79} \linebreak
		wьnvь [vinvә = тайно, крадучись] \cite[л. 56]{spbfaran79} % винвэ
	& 	тайный
	&	
	& 	
	& 	+ \\ \midrule
\tenevilglyph{c_J}
	...
	& 	+ \\ \midrule
\tenevilglyph{c_J_2j}
	&	nutesqan [nutæsqәn = земля, почва] \cite[л. 39]{spbfaran79} % нутэсӄын
	& 	
	&	
	& 	
	& 	+ \\ \midrule
\tenevilglyph{i_2bX}
	&	сразу \cite[л. 51]{spbfaran79} \linebreak
		awetuwaq [= быстро, проворно, сразу] \cite[л. 56]{spbfaran79} % авэтываӄ
	& 	сразу
	&	
	& 	
	& 	\\ \midrule
...
\tenevilglyph{u_v_cD}
	&	вполне \cite[л. 51]{spbfaran79} \linebreak
		arala [= совсем, вовсе] \cite[л. 52]{spbfaran79} % аръаԓя
	& 	
	&	
	& 	
	& 	+ \\ \midrule
...
\tenevilglyph{oF_2l_lG}
	&	близко \cite[л. 51, 53]{spbfaran79} \linebreak
		\textbarc ьm\textbarc ә [cьmcь = близко] \cite[л. 54]{spbfaran79} \linebreak % чымче
...
\tenevilglyph{cU_2cD}
	...
	& 	+ \\ \midrule
\tenevilglyph{o_2CE}
	&	milgьrә [milgьr = ружье] \cite[л. 54]{spbfaran79} \linebreak % миԓгэр
...
\tenevilglyph{o_2q}
	&	1 \cite[л. 64]{spbfaran79} \linebreak
		amunen [әnnæn? = один] \cite[л. 39 об]{spbfaran79} % ыннэн
	& 	
	&	
	& 	1
	& 	+, 1 \\ \midrule
...
\tenevilglyph{o_2q_q_l}
	&	три \cite[л. 41]{spbfaran79} \linebreak
		ŋьroq [= три] \cite[л. 39]{spbfaran79} \linebreak % ӈыроӄ
...
\tenevilglyph{o_T_2q_2o_l_j} % Как 15, но с крючком, обычно обозначающим 20. Кроме того, на «лунном календаре», в контексте, видимо, числа, где есть этот знак, 60, 4 и 1, то есть если это в самом деле 15*20=300, то сумма будет 365
	...
	& 	+, [300] \\ \midrule
\tenevilglyph{CD_CDY}
	&	тем не менее, wenlьgь [vænligi = тем не менее] \cite[л. 42]{spbfaran79} \linebreak % вэнԓыги
...
\tenevilglyph{O_L_2q}
	...
	& 	+ \\ \midrule
\tenevilglyph{i_SX}
	&	alьmь [= положим, что] \cite[л. 52 об]{spbfaran79} % аԓымы?
	& 	
	&	
	& 	
	& 	+ \\ \midrule
...
\tenevilglyph{2CY}  % С лисами сплошная путаница
	&	reqokalgьn [= лисица, песец] \cite[л. 54]{spbfaran79} % рэӄокаԓгын
	& 	
	&	
	& 	песец
	& 	\\ \midrule
...
\tenevilglyph{2cF_2k_cFY} 
	&	заяц \cite[л. 46]{spbfaran79} \linebreak
		melitolgьn [melotalgьn = заяц] \cite[л. 54]{spbfaran79} % мэԓётаԓгын
	& 	заяц
	&	a hare
	& 	
	& 	\\ \midrule
...
\tenevilglyph{v_i_2CX} 
	...
	& 	+ \\ \midrule
\tenevilglyph{i_i_bX} 
	&	ŋocьm [ŋocьn = бедняк] \cite[л. 39 об]{spbfaran79} % ӈъочьын
	& 	богатый
	&	
	& 	
	& 	\\ \midrule
\tenevilglyph{oEN_q} 
	&	goymьcьl(?) [gajmьcьjьn = богач] \cite[л. 39 об]{spbfaran79} % гаймычьыԓьын
	& 	бедный
	&	
	& 	
	& 	\\ \midrule
...
\tenevilglyph{i_u_uD_b} 
	&	grep [græp = песня] \cite[л. 64 об]{spbfaran79} % грэп
	& 	
	&	
	& 	
	& 	\\ \midrule
...
\tenevilglyph{CD-CDX_l} 
	&	ониметник [?] \cite[л. 66 об]{spbfaran79}
	& 	
	&	
	& 	
	& 	+ \\ \midrule
