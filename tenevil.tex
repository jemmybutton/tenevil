...
\tenevilglyph[yes][4][T]{*cT} 
	...
	&	t [слово напечатано] [12.9, 12.12] \linebreak
		...
		\tabularnewline \midrule 
\tenevilglyph[yes][2][Y]{*jT,*g} % TODO: добавить источник; возможно, вообще обозначает гортанную смычку
	&	ы 
	&	
	&	
	&	
...
\tenevilglyph[yes][4]{2LE} 
	...
	& 	[25.4об] \linebreak
		...
		tiьlьŋurkьt \currentGlyphWithAffixes{}{Y,T,K} [ИЛИ:2.21] \linebreak % TODO: нужен перевод; YT тут немного загадка
