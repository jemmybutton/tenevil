...
\tenevilglyph[yes][4]{o-_s}
	...
	&	
	&
	& 	ььt [гыт]  [5.1об] \currentGlyphWithAffixes{}{T} % закорючка справа, вероятно, фонетическая 
		\tabularnewline \midrule
...
\tenevilglyph[yes][4]{f-b}
	...
	&	
	&	
	& 	pioneren [пионерэн = пионерский; напечатано в книге, знак рядом] [12.18об] \currentGlyphWithAffixes{}{E} \linebreak
		pionerte [пионертэ = пионеры; напечатано в книге, знак рядом] [12.18об] \currentGlyphWithAffixes{}{T} \linebreak
		pioneretь [напечатано в книге, знак рядом] [12.18об] \currentGlyphWithAffixes{}{T} \linebreak % TODO: нужен перевод, нужна транскрипция
		pionero [напечатано в книге, знак рядом] [12.18об] \currentGlyphWithAffixes{}{A} \linebreak
		\tabularnewline \midrule
...
\tenevilglyph[yes][1]{i_4l_b}
	...
	&	
	&	
	& 	nьtemqen [ИЛИ:1.17] \currentGlyphWithAffixes{}{E} \linebreak % TODO: нужен перевод, нужна транскрипция
		gьtepьciьn [ИЛИ:1.17] \currentGlyphWithAffixes{}{YN} \linebreak % TODO: нужен перевод, нужна транскрипция
		\tabularnewline \midrule
...
\tenevilglyph[yes][3]{u_2l_c_z_oF_oN}
	...
	&	посёлок Снежное [110]
	& 	\cite[364]{davydova2015a} \linebreak
		пасык [34.8] \currentGlyphWithAffixes{}{K} % TODO: нужна интерпретация
		\tabularnewline \midrule
...
\tenevilglyph[yes][4]{U_qD_b}
	...
	& 	\cite[362]{davydova2015a} \linebreak
		lelelgьn [ԓеԓеԓгын; напечатано в книге, знак рядом] [12.23об]  \currentGlyphWithAffixes{}{E} \linebreak
		lilit [ԓиԓит; напечатано в книге, знак рядом] [12.23об] \currentGlyphWithAffixes{}{T}
		\tabularnewline \midrule
...
\tenevilglyph[yes][4]{sE_jFE}
	...
	& 	\cite[360]{davydova2015a} \linebreak
		...
		perejo [= взятое; напечатано в книге, знак рядом] [12.23об] \currentGlyphWithAffixes{}{A}
		опере [берет] [30.7] \currentGlyphWithAffixes{}{P,L}
		\tabularnewline \midrule
\tenevilglyph[yes][4]{sE_jFE_qY}
	...
	&	
	&
	& 	ырыпота [работа] [35.1] \currentGlyphWithAffixes{}{E,M} \linebreak
		рыпосе [работе] [34.18об] \currentGlyphWithAffixes{}{L,E} \linebreak
		mьceretьk [ИЛИ:1.4] \currentGlyphWithAffixes{}{K}
		\tabularnewline \midrule
...
\tenevilglyph[yes][4]{o-o_z} 
	...
	& 	[6.1] \linebreak
		lelalgьn [ԓыԓяԓгын = глаз; напечатано в книге, знак рядом] [12.23об] \currentGlyphWithAffixes{}{E} \linebreak
		lilet [ԓыԓет = глаза; напечатано в книге, знак рядом] [12.23об] \currentGlyphWithAffixes{}{T}
		\tabularnewline \midrule
...
\tenevilglyph[yes][3]{i_b_jF} 
	...
	&	
	&	поселок Анадырь [11]
	&	анатры  [37.2] \currentGlyphWithAffixes{}{T}
		\tabularnewline \midrule 
