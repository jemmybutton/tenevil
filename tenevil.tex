...
\begin{document}
\begin{landscape}
\begin{longtable}{p{1.5cm}>{\raggedright}p{9.5cm}p{3cm}>{\raggedright}p{3cm}>{\raggedright}p{3cm}>{\raggedright}p{4.5cm}}
\toprule
...
\tenevilglyph{O_L_2q}
	...
	& 	 \cite[26]{lavrov1969} 
		\tabularnewline \midrule
\tenevilglyph[no]{O_L}
	&	«бурка» [пурга] или «коломеи» \cite[л. 68 об]{spbfaran79} 
	& 	
	&	
	& 	
	& 	 \tabularnewline \midrule
...
\tenevilglyph{i_b_jX} 
	...
	& 	\cite[363]{davydova2015a} \linebreak
		вот [32.6] \linebreak
		ŋotьqen [ŋotьqәn = вон тут] [4.10об] % НУЖЕН ПЕРЕВОД ӈотыӈкы? ӈотыӈӄэн?
		\tabularnewline \midrule
\tenevilglyph{2b_2l} 
	&	
	& 	
