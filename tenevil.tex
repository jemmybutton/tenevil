...
\tenevilglyph[yes][4]{f}
	...
	& 	\cite[360, 361, 364]{davydova2015a}\linebreak
		...
		orawetletь [напечатано в книге, знак рядом] \currentGlyphWithAffixes{}{T} [12.20об]
		\tabularnewline \midrule
\tenevilglyph[yes][3]{f_4q}
	...
	& 	сапране [собрание] [36.1] \linebreak
		numeketьnet [нумэкэтынэт = пусть собираются] \currentGlyphWithAffixes{}{T} [12.16об] % TODO: уточнить транскрипцию, уточнить перевод
		\tabularnewline \midrule
...
\tenevilglyph[yes][4]{f-b}
	...
	& 	pioneren [пионерэн = пионерский; напечатано в книге, знак рядом] \currentGlyphWithAffixes{}{E} [12.18об] \linebreak
		pionerte [пионертэ = пионеры; напечатано в книге, знак рядом] \currentGlyphWithAffixes{}{T} [12.18об] \linebreak
...
\tenevilglyph[yes][4]{sE_jFE}
	...
	& 	\cite[360]{davydova2015a} \linebreak
		...
		опере [берет] \currentGlyphWithAffixes{}{P,L} [30.7]
		\tabularnewline \midrule
...
\tenevilglyph[yes][3]{SYE_2q} 
	...
	&	tur-ermete [tur-ærmæt = советская власть; напечатано в книге, знак рядом] [12.15об] \linebreak % TODO: уточнить перевод, нужна транскрипция
		tur-eremete [tur-ærmæt; напечатано в книге, знак рядом] \currentGlyphWithAffixes{}{T} [12.15]
		\tabularnewline \midrule
...
\tenevilglyph[yes][2]{b-b-u} 
	...
	&	
	&	
	&	ратьё, привезенный, рэтык, привезти [36]
...
\tenevilglyph[yes][3]{uT_pF_b} 
	...
	&	
	&	
	&	вэлыткук [виԓыткук = торговать], торговать [11]
	&	\cite[360]{davydova2015a} \linebreak
		в «макасен» [магазин] [32.14] \linebreak
		в «макачйн» [магазин] [32.14] \linebreak
		weleunwk \currentGlyphWithAffixes{}{T} [ИЛИ:1.19] % TODO: нужен перевод
		\tabularnewline \midrule 
\bottomrule
\end{longtable}
\end{landscape}
