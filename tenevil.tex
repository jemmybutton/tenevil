...
\theglyph~{\IfNoValueTF{#2}{}{(#2)}}\hfill~\linebreak{%
	...
	\IfNoValueTF{#3}{}{%
		...
		\write\shortcuts{\string\def\expandafter\string\csname TenevilGlyph#3\endcsname{#4}}%
	}%
	\stepcounter{glyph}%
}
...
\tenevilglyph[yes][1]{I_2qY} 
	...
	&	rьcьk \currentGlyphWithAffixes{}{K} [ИЛИ:1.5] \linebreak
		...
		rэсьnen \currentGlyphWithAffixes{}{E} [ИЛИ:1.7]
		\tabularnewline \midrule 
...
\tenevilglyph[yes][4]{o_lN_l} % значок почти наверняка другой, но в чем разница — непонятно
	...
	& 	jaraŋь [яраӈы = яранга] [ИЛИ:1.12] \linebreak
		...
		kaletkoragtь [каԓеткорагты = в школу; слово напечатано] \currentGlyphWithAffixes{}{kalekal} [12.18] \linebreak % TODO: нужен перевод
...
\tenevilglyph[yes][5]{c_cD_b} 
	...
	& 	пееано [пьяный] \currentGlyphWithAffixes{ruk}{} [30.3] \linebreak
		ieqemьluk  \currentGlyphWithAffixes{ruk}{A,K} [ИЛИ:2.26] \linebreak
...
\tenevilglyph[yes][4]{o_2q_2j} 
	...
	& 	[25.10] \linebreak
		...
		песмо [письмо] \currentGlyphWithAffixes{}{kalekal} [34.8об] 
		\tabularnewline \midrule
...
\tenevilglyph[yes][1]{uT_pF} 
	...
	&	nenejlqn \currentGlyphWithAffixes{}{E} [ИЛИ:1.4] \linebreak % TODO: нужен перевод
		эjьlke [эйылкэ = не давать] \currentGlyphWithAffixes{etly}{} [ИЛИ:2.25] \linebreak % TODO: уточнить перевод
		\tabularnewline \midrule 		
