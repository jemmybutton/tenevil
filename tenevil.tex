...
\tenevilglyph[yes][4]{o_l_jF}
	...
	& 	зиокочайс [закончилось] [32.15] \linebreak
		...
		mьtьplьtkunet [мытыплыткунэт = окончили; слово напечатано] [12.24] \linebreak % TODO: уточнить перевод и транскрипцию
...
\tenevilglyph[yes][5]{i_J}
	...
	& 	nьmeleu [нымэԓьэв = хорошо, разумно] [12.17] \linebreak 
		...
		nьmelqen [нымэлӄин = хороший, доброкачественный] [ИЛИ:1.6]
		\tabularnewline \midrule
...
\tenevilglyph[yes][3]{CD_4j} 
	...
	&	
	&	
	&	nьlqьrernen [нылӄырирӄин = искали] \currentGlyphWithAffixes{}{R,Q,L} [ИЛИ:2.4]
		\tabularnewline \midrule 
