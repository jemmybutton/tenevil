...
\tenevilglyph[yes][4]{R_2bN}
	...
	& 	\cite[361]{davydova2015a} \linebreak
		...
		kuprete [купрэтэ = сетями] \currentGlyphWithAffixes{}{T} [12.25] % TODO: уточнить перевод и транскрипцию
		\tabularnewline \midrule 
...
\tenevilglyph[yes][3]{j_b_q_2q} 
	...
	&
	& 	\cite[360]{davydova2015a} \linebreak
		tьlerkьt [= движутся; напечатано в книге, знак рядом] [7.12об] % TODO: уточнить перевод
		\tabularnewline \midrule
