...
%			либо интерпретация написанного Теневилем вызывает сомнения, либо это имя личное без понятной транскрипции
...
%		5:	сильная уверенность, несколько независимых источников сходятся на одном значении, работает в контексте,
...
\tenevilglyph[yes][2]{iY_iX} 
	&	часть «облез (кусок) шкуры лахтака» \cite[л. 48]{spbfaran79}
	&	
	& 	\cite[364]{davydova2015a} \linebreak
