...
\toprule
 ...
 \tenevilglyph[yes][4]{uF_2l} % TODO: убедиться, что это не то же самое, что предыдущий, пока похоже, что нет, в 30.8об встречается, но лучше найти на одном листе
	...
	& 	чочо [чуть-чуть] [30.7об] \linebreak
		...
		qьmek [ӄымэк = чуть-чуть, почти, едва не, чуть не] [ИЛИ:1.5] % TODO: нужна транскрипция латиницей
		\tabularnewline \midrule
 \tenevilglyph[yes][4]{i_jX}
	&	 ?...gite...* \cite[л. 39 об]{spbfaran79} % TODO:  нужна расшифровка, нужен перевод
	&	
	&
	& 	rinut [ръэнут = что, что-нибудь] [ИЛИ:1ю15] % TODO: нужна транскрипция латиницей
		\cite[360, 362, 364]{davydova2015a} 
		\tabularnewline \midrule
 ...
 \tenevilglyph[yes][3]{i_CD_2jF} 
	...
	&
	& 	\cite[364]{davydova2015a} \linebreak
		толко [далеко] [34.11об] \linebreak
		ьriэc [?] [ИЛИ:1.6] % TODO: нужен перевод
		\tabularnewline \midrule
 ...
 \tenevilglyph[yes][1]{3iX} 
	...
	& 	месе [?] [29.11, 34.21об, 39.5об] 
		ceke [?] [ИЛИ:1.14] % TODO: нужен перевод
		\tabularnewline \midrule
 ...
 \tenevilglyph[yes][1]{cF_2JY} 
	...
	& 	неветау [?] [30.7об] \linebreak
		gewwtь [?] [ИЛИ:1.7] % TODO: нужен перевод
		\tabularnewline \midrule
