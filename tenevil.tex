...
\tenevilglyph[yes][5]{iY}
	...
	& 	\cite[360, 361, 364]{davydova2015a} \linebreak
		...
		ьnqenat [ынӄэнат = эти] \currentGlyphWithAffixes{}{T} [ИЛИ:1.8об] \linebreak % ilispread:1.9
		эмынхен [эмынӄэн = только это] \currentGlyphWithAffixes{ymy}{} [41.7] % NB: Обрати внимание, используется ымы вместо двух отдельных скобочек да ам-/эм-. Возможно, указание на происхождение последних от знака для ымы
		\tabularnewline \midrule
