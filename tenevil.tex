...
\def\argthree{#3}%
	...
	\ifx\argthree\empty{}\else%
		\clist_map_inline:nn { #3 } {\tenevilfont\selectfont\fontchar{\csname TenevilGlyph##1\endcsname}}%
	\fi%
	}
}
\ExplSyntaxOff
...
\tenevilglyph[yes][4]{i_b_s_j_B-}
	...
	& 	2000 [36.2] 
		\tabularnewline \midrule
\tenevilglyph[yes][5]{o_2q_q_l,TD_l}
	&	3
...
\tenevilglyph[yes][5]{o-_2q_j,jF_2j}
	...
	& 	8 \cite[360]{davydova2015a} \linebreak
		8 [напечатано] \currentGlyphWithAffixes[2]{}{} [12.14]
		\tabularnewline \midrule
