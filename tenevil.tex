...
\tenevilglyph[yes][3]{i_2lY}
	...
	& 	\cite[364]{davydova2015a} \linebreak
		\cite[28]{lavrov1969} 
		\tabularnewline \midrule
\tenevilglyph[yes][1]{i_l_q_lY} % TODO: Вероятно имя собственное, но надо проверить, в данном случае, возможно, русское имя жены Теневиля
	&
	&	
	& 	Rая [?] [32.10] 
		\tabularnewline \midrule
