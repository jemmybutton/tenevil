...
\tenevilglyph[yes][4][Q]{*bTF_jT}  
	...
	&	plaq \currentGlyphWithAffixes{P,L,A}{} [ИЛИ:2.13] \linebreak % TODO: нужен перевод
		...
		\tabularnewline \midrule 
\tenevilglyph[yes][2][b]{*jT,*g} % TODO: добавить источник
	&	ь,ъ,' 
	&	
	&	
	&	
...
\tenevilglyph[yes][3]{R_2bN_bXX}
	&	
	&	свашот [свяжут] \cite[л. 68]{spbfaran79} % TODO: нужна интерпретация
	& 	
	&	
	& 	~[4.4об]
		\tabularnewline \midrule 
...
\tenevilglyph[yes][5]{i_g_b}
	...
	& 	\cite[361]{davydova2015a} \linebreak 
		...
		qetaqet [ӄэтаӄэт = кета; слово напечатано] [12.24об] \linebreak % TODO: нужна транскрипция латиницей
...
\tenevilglyph[yes][4]{2OX_l} 
	...
	& 	\cite[364]{davydova2015a} \linebreak
		nьketguqenet [ныкэтгуӄинэт] [ИЛИ:1.3] \linebreak % TODO: нужна транскрипция латиницей
