...
\tenevilglyph[yes][3][K]{*'} 
	...
	&	
	&	
	&	к* [2] % тут три черточки вместо одной
...
\tenevilglyph[yes][3]{j_b_q_2q} 
	...
	& 	\cite[360]{davydova2015a} \linebreak
		...
		tьlama [тыԓяма = по дороге; напечатано в книге, знак рядом] \currentGlyphWithAffixes{}{A} [12.10об]
		\tabularnewline \midrule
...
\tenevilglyph[yes][3]{uT_pF_b} 
	...
	&	\cite[360]{davydova2015a} \linebreak
		...
		kunnin [= купил; напечатано в книге, знак рядом] \currentGlyphWithAffixes{}{E} [12.15] \linebreak % TODO: уточнить перевод, нужна транскрипция
