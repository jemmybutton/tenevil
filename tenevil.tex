...
\tenevilglyph[yes][3]{lE_JXE} 
	...
	& 	эŋilerkьt [эӈъэԓетыркыт = устают] [ИЛИ:1.5] \linebreak %TODO: уточнить перевод
		neŋieletqen [нэӈъэԓетӄин = с трудом] \currentGlyphWithAffixes{}{N} [ИЛИ:2.7] \linebreak
...
\tenevilglyph[yes][3]{JE_q} 
	...
	&	\cite[361]{davydova2015a} \linebreak
		...
		qoraьretlien [ӄорагынрэтыԓьэн = оленевода] \currentGlyphWithAffixes{}{qorany,b,N} [ИЛИ:2.15] 
		\tabularnewline \midrule 
