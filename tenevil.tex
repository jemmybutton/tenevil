...
\tenevilglyph[yes][3]{i_u_uD} 
	...
	&	
	&	
	& 	ejŋei [= крикнул] [12.22об] % TODO: уточнить перевод, явно от ejŋæ = хрипеть, нужна транскрипция
		\tabularnewline \midrule
...
\tenevilglyph[yes][3]{o_L_LE} 
	...
	&	
	&	
	& 	qәtwuunat [= назови] [12.24об] \linebreak % TODO: уточнить перевод, нужна транскрипция
		qәtwuun [= расскажите] [12.25] % TODO: уточнить перевод, нужна транскрипция
		\tabularnewline \midrule
