...
\tenevilglyph[yes][4]{2LE} 
	...
	& 	[25.4об] \linebreak
		...
		tiьcgьrgьn [тъычгыргын = болезнь] \currentGlyphWithAffixes{}{Y,T} [ИЛИ:2.4] 
		\tabularnewline \midrule
\tenevilglyph[yes][3]{i_2q_JXEEN} 
	&	тъычгыргын
	&	
	&	
	&	тычгыргын [тъычгыргын = болезнь], аргыргын, болезнь [61] % TODO: нужен перевод
	&	tәçьrgьn [tәçgьrgьn, тъычгыргын; слово напечатано]  [12.20об] 
		\tabularnewline \midrule 
