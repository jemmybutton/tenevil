...
\tenevilglyph[yes][1]{o-_j_jY}
 ...
 \tenevilglyph[yes][2]{cF_CF}
	&	так \cite[л. 50]{spbfaran79} \linebreak
		әnmen [ынӈин = так, такой] \cite[л. 39 об]{spbfaran79} \linebreak % ынӈин
 ...
 \tenevilglyph[yes][4]{i_jX}
	...
	&
	& 	\cite[360, 362, 364]{davydova2015a} \linebreak
		rinut [ръэнут = что, что-нибудь] [ИЛИ:1.15] % TODO: нужна транскрипция латиницей
 ...
 \tenevilglyph[yes][2]{q_c_cD_q} 
	...
	& 	сороно [всё равно] [34.11об] \linebreak
		tьmŋalgulaq [ИЛИ:1.9] % TODO: нужен перевод
		\tabularnewline \midrule
