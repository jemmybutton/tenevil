...
\tenevilglyph{u_2j} 
	...
	& 	[25.4] \\ \midrule
\tenevilglyph{c_C_2j} 
	&	собака \cite[л. 68 об]{spbfaran79} % зеркально
	& 	
	&	
	& 	
	& 	[25.3] \\ \midrule
\tenevilglyph{k_2j} 
	&	щаи [чай] \cite[л. 68 об]{spbfaran79} % зеркально
	& 	
	&	
	& 	
	& 	[25.9] \\ \midrule
...
\subsection{СПбФ АРАН. Ф. 250. Оп. 1. Д. 79} % Надо дописать про остальные листы
...
Три таблицы с переводами ряда символов на русский. Фотографии «лунного календаря» и «родового дерева» , нарисованных Теневилем.
