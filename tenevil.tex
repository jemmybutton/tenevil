...
% J — крючок
% B — петля
% S — s-образный элемент
% G — спираль
% L — кочерга
% I — палка
% Q — маленькая черточка
% E — щетка
...
\tenevilglyph[yes][5]{b_q}
	...
	& 	\cite[360, 361, 362, 364]{davydova2015a} \linebreak
		...
		\tabularnewline \midrule
\tenevilglyph[yes][5][ymylxo]{2i_2cD_2l}
	&	ымыԓьо
...
\tenevilglyph[yes][5][melgytanvyn]{vY_z}
	...
	& 	\cite[364]{davydova2015a} \linebreak
		...
		\tabularnewline \midrule
\tenevilglyph[yes][3]{vY_z_i_qY_vD_iX}
	&	
	&	
...
\tenevilglyph[yes][5]{bD_b_vY_z}
	...
	& 	ленн [Ленин] [34.9] \linebreak % NB: часть «ԓыгэн» тут, видимо, в качестве фонетической компоненты 
		...
		\tabularnewline \midrule
\tenevilglyph[yes][3]{vY_z_2o_2j_c} 
	&	
	&	
	&	
	&	
	& 	korelenko [возможно, Куриленко, инструктор олентреста\cite{druri1989}] [ИЛИ:1.16об] % ilispread:1.16 % TODO: уточнить интерпретацию
		\tabularnewline \midrule
\tenevilglyph[yes][3]{vY_z_2cU_b_2jF} % NB: тут то же, что с «Ленин», но с «ваԓы»
	&	Валя
	&	
	&	
	...
	& 	[3.50об,3.58об,3.83]
		\tabularnewline \midrule
\tenevilglyph[yes][1]{vY_z_2cU_U_q_b} 
	&	
	&	
	&	
	&	
...
\tenevilglyph[yes][5][nymnym]{2o_2j}
	...
	& 	\cite[364]{davydova2015a} \linebreak
		...
		\tabularnewline \midrule
\tenevilglyph[yes][3][remkyn]{2o_2j_JFE}
	&	рэмкын
	&	
