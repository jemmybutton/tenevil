...
\tenevilglyph{j_l_i}
	&	с этих пор \cite[л. 40]{spbfaran79} \linebreak
		wutkelegnek (?) \cite[л. 54]{spbfaran79}  % НУЖЕН ПЕРЕВОД
	& 	с этих пор
	&	
	& 	
	& 	\\ \midrule
...
\tenevilglyph{U_v}
	&	сказал \cite[л. 41]{spbfaran79} \linebreak
		giulin \cite[л. 52]{spbfaran79} % НУЖЕН ПЕРЕВОД
	& 	сказал
	&	
	& 	
	& 	+ \\ \midrule
...
\tenevilglyph{UD_2B}
	&	жить \cite[л. 41]{spbfaran79} \linebreak
		nyegtel \cite[л. 39]{spbfaran79} \linebreak % НУЖЕН ПЕРЕВОД
...
\tenevilglyph{UE}
	&	становиться \cite[л. 41]{spbfaran79} \linebreak
		mьnneel \cite[л. 39]{spbfaran79} \linebreak % НУЖЕН ПЕРЕВОД
...
\tenevilglyph{c_JY}
	&	покинул \cite[л. 41]{spbfaran79} \linebreak
		enapelae \cite[л. 52]{spbfaran79} \linebreak % НУЖЕН ПЕРЕВОД
...
\tenevilglyph{4L}
	&	плакать \cite[л. 41]{spbfaran79} \linebreak
		nьtergьtьm \cite[л. 52]{spbfaran79} % НУЖЕН ПЕРЕВОД
	& 	
	&	
	& 	
	& 	+ \\ \midrule
...
\tenevilglyph{o_3iS}
	...
	& 	+ \\ \midrule
\tenevilglyph{u_o_b}
	&	как же, miŋkri-li \cite[л. 43]{spbfaran79} \linebreak % миӈкри-? НУЖЕН ПЕРЕВОД
