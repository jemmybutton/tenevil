...
\tenevilglyph[no][3]{l-l_i}
	...
	& 	[1.4об, 4.2об]* % TODO: ` начинается чуть в другом месте, но похоже, по смыслу должно быть то
		\tabularnewline \midrule
...
\tenevilglyph[yes][1]{b_a}
	&	
	&	
	& 	капетка (каретка?) [?] [29.12] % TODO: проверить, может это тот же знак, что и предыдущий, что-то вроде ӄор-атӄы (но конкретно это неправильно)
		\tabularnewline \midrule
