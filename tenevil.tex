...
\tenevilglyph[yes][3][O]{*cTR_2jF} 
	...
	&	карломаркз [Карл Маркс] \currentGlyphWithAffixes{K,A,L}{M,melgytanvyn} [44.62] \linebreak
		зехорзкй \currentGlyphWithAffixes{C,Q}{R,melgytanvyn} [42.11] % TODO: нужна интерпретация, явно какое-то имя
		\tabularnewline \midrule 
...
\tenevilglyph[yes][4]{U_Q_b}
	...
	& 	wetgau [wetgaw, вэтгав = слово, речь; слово напечатано] [12.24]
		kalewetgawkь [каԓевэтгавкы = научится читать; слово напечатано] \currentGlyphWithAffixes{}{kelikel} [12.18] % TODO: уточнить перевод
		\tabularnewline \midrule
