...
\stepcounter{glyph}%
\global\expandafter\def\expandafter\allchars\expandafter{\allchars{ }\tenevilfont\fontsize{40pt}{40pt}\selectfont\fontchar{#4}}
}
...
\tenevilglyph[yes][4]{2OX_j}
	...
	&	
	& 	\cite[360, 364]{davydova2015a} \linebreak
		в «полчои» [большой]* [29.12] \linebreak
...
\tenevilglyph[yes][5]{f_c}
	...
	& 	\cite[364]{davydova2015a} \linebreak
		...
		warata [варата = народом] \currentGlyphWithAffixes{}{T,A}
		\tabularnewline \midrule
...
\tenevilglyph[yes][5]{vY_z}
	...
	& 	\cite[364]{davydova2015a} \linebreak
		...
		ьrucket \currentGlyphWithAffixes{R,K,T}{} [ИЛИ:2.20]
		\tabularnewline \midrule
...
\tenevilglyph[yes][2]{cU_2q_cD_2q}
	...
	& 	\cite[360–362, 364]{davydova2015a} \linebreak
		...
		jaat \currentGlyphWithAffixes{}{T} [ИЛИ:1.19]
		\tabularnewline \midrule
...
\tenevilglyph[yes][5]{o_2q_j}
	...
	&	20 \cite{lavrov1969}
	&	кликкин [ӄԓиккин = двадцать], 20, двадцать [44] % TODO: нужна транскрипция
...
\tenevilglyph[yes][5]{o_2q_q_l}
	...
	& 	3 \cite[360, 362]{davydova2015a} \linebreak
		\cite[361, 363, 364]{davydova2015a} \linebreak
		ŋьrurgare [ӈыроргарэ = трое] [ИЛИ:1.9]
		\tabularnewline \midrule
\tenevilglyph[yes][5]{TD_l}
	&	3 (вариант начертания)
	&	
	&	
	&	
	& 	3 [4.1об]
...
\tenevilglyph[yes][5]{o_q_c_T}
	...
	& 	4 \cite[360]{davydova2015a} \linebreak
		...
		\cite[26]{lavrov1969} 
		\tabularnewline \midrule
\tenevilglyph[yes][5]{q_c_t}
	&	4 (вариант начертания)
	&	
	&	
	&	
	& 	4 [4.1об]
...
\tenevilglyph[yes][5]{oI_2j}
	...
	&	5 \cite{lavrov1969}
	&	мытлын'эн [мытԓыӈэн = пять], 5, пять [43] % TODO: нужна транскрипция
	& 	5 \cite[360]{davydova2015a} \linebreak
		\cite[361, 364]{davydova2015a} \linebreak
		mьlьŋen [мытԓыӈэн] [ИЛИ:2.14]
		\tabularnewline \midrule
...
\tenevilglyph[yes][5]{o-_q_jF_o}
	...
	&	6 \cite{lavrov1969}
	&	ыннанмытлын'эн [ыннанмытԓыӈэн = шесть], 6, шесть [43] % TODO: нужна транскрипция
...
\tenevilglyph[yes][5]{o_j_2q}
	...
	&	7 \cite{lavrov1969}
	&	н'эрэкмытлын'эн [ӈэръамытԓыӈэн = семь], 7, семь [43] % TODO: нужна транскрипция
	& 	7 \cite[360]{davydova2015a} \linebreak
		\cite[361]{davydova2015a} \linebreak
		ŋeriamьlьŋen [ӈэръамытԓыӈэн] [ИЛИ:2.14]
		\tabularnewline \midrule
\tenevilglyph[yes][5]{j_2q}
	&	7 (вариант начертания)
	&	
	&	
	&	
	& 	7 [12.14]
...
\tenevilglyph[yes][5]{o-_2q_j}
	...
	& 	8 \cite[360]{davydova2015a} 
		\tabularnewline \midrule
\tenevilglyph[yes][5]{jF_2j}
	&	8 (вариант начертания)
	&	
	&	
	&	
	& 	8 [12.14]
...
\tenevilglyph[yes][5]{o_2q_jN_jF_o}
	...
	&	9 \cite{lavrov1969}
	&	коначгын'кэн [ӄонъачгынкэн = девять], 9, девять [44] % TODO: нужна транскрипция
...
\tenevilglyph[yes][4]{o_lN_l} % значок почти наверняка другой, но в чем разница — непонятно
	...
	& 	jaraŋь [яраӈы = яранга] [ИЛИ:1.12] \linebreak
		jarapь [ярайпы = из яранги] \currentGlyphWithAffixes{}{P} [ИЛИ:1.19] % TODO: нужен перевод
		\tabularnewline \midrule
...
\tenevilglyph[yes][3]{i_2j_2cY} 
	...
	& 	\cite[28]{lavrov1969} \linebreak
		tilme [слово напечатано] [12.13] % TODO: нужен перевод, нужна транскрипция
		\tabularnewline \midrule
...
\tenevilglyph[yes][1]{3k} 
	...
	& 	\cite[364]{davydova2015a} 
		...
		iьnьlgьrkьn  \currentGlyphWithAffixes{}{YN} [ИЛИ:2.5] % TODO: нужен перевод
		\tabularnewline \midrule
...
\tenevilglyph[yes][4]{r_t} 
	...
	& 	пыраснек [праздник] [34.10об] \linebreak
		...
		эeŋeŋkь [ИЛИ:1.14] \linebreak % TODO: нужна транскрипция
		эeŋeŋkь \currentGlyphWithAffixes{}{K} [ИЛИ:2.26] \linebreak
...
\tenevilglyph[yes][4]{c_cD} 
	...
	& 	iomtьma [о'птыма] [ИЛИ:1.3] \linebreak % TODO: нужен перевод
		...
		qьnur [ӄынур] \currentGlyphWithAffixes{}{Q,E,R} [ИЛИ:2.8]
		\tabularnewline \midrule
...
\tenevilglyph[yes][3]{i_sXY} 
	...
	&	
	&	
	& 	jaleьtь [яаԓегты = позднее] \currentGlyphWithAffixes{}{T} [ИЛИ:1.16] 
		\tabularnewline \midrule
...
\tenevilglyph[yes][5]{SYE} 
	...
	&	эerьm [ærьm, эрым = начальник, глава, староста] [ИЛИ:1.14] \linebreak
		...
		armaьtь [армагты = начальству] \currentGlyphWithAffixes{}{A,T} [ИЛИ:1.3] % Weinstein TODO: уточнить перевод
		\tabularnewline \midrule
...
\tenevilglyph[yes][3]{i_4'} 
	...
	&	
	&	
	&	в «qәjnewnin» [= стреляли; слово напечатано] [12.22] % TODO: уточнить перевод, нужна транскрипция
		\tabularnewline \midrule 
...
\tenevilglyph[yes][3]{L_uD} 
	...
	&	petьqetie [пинтыӄэтгъи = появился] [ИЛИ:2.17] % Weinstein TODO: уточнить перевод
		\tabularnewline \midrule 
\tenevilglyph[yes][1]{JE_q} 
	&	
	&	
	&	
	&	
	&	\cite[361]{davydova2015a} \linebreak
		gьretьk \currentGlyphWithAffixes{}{T,K} [ИЛИ:2.23] \linebreak % TODO: нужен перевод
		mьgьrerkьnet \currentGlyphWithAffixes{M}{R,K} [ИЛИ:2.23] 
		\tabularnewline \midrule 
